...
private void kosong(){
    ...
    tglkembalii.setDate(null);
    tglkembalii.setEnabled(false);  
...
private void tampil(){
    ...
    private void initComponents() {
        ...
        tglkembalii = new com.toedter.calendar.JDateChooser();
        ...
        tglkembalii.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                tglkembaliiPropertyChange(evt);
            }
        });
        jPanel1.add(tglkembalii, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 480, -1, -1));
...
if (tglkembalii.getDate() != null) {
     SimpleDateFormat FormatTanggal = new SimpleDateFormat("dd MMMM yyyy");
     pulang = FormatTanggal.format(tglkembalii.getDate());
}
try {
...
txtkembalian.setEditable(false);
  ...
  txtbayar.setEditable(false);
    ...
    private void tglkembaliiPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_tglkembaliiPropertyChange
        // TODO add your handling code here:
        
      if (tglkembalii.getDate() != null) {
     SimpleDateFormat FormatTanggal = new SimpleDateFormat("dd MMMM yyyy");
     kembali = FormatTanggal.format(tglkembalii.getDate());
}
    }//GEN-LAST:event_tglkembaliiPropertyChange
    ...
    private com.toedter.calendar.JDateChooser tglkembalii;
