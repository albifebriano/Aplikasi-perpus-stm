...
private void setcombo(){
    ...
    cmbfakultas.addItem("RPL");
    cmbfakultas.addItem("TKJ");
    cmbfakultas.addItem("ELIN");
    cmbfakultas.addItem("las");
    cmbfakultas.addItem("tkr");
    ...
    private void initComponents() {
        ...
        cmbfakultas.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "jurusan" }));
        ...
        cmbprodi.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "kelas" }));
...
txtnpm.setText(null);
    ...
    private void cmbfakultasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbfakultasActionPerformed
     ...
     if(cmbfakultas.getSelectedItem().equals("jurusan")){
        
         cmbprodi.setSelectedItem("kelas");
    cmbprodi.setEnabled(false);
     }
        else if(cmbfakultas.getSelectedItem().equals("RPL")){
        cmbprodi.setEnabled(true);
        cmbprodi.removeAllItems();
        cmbprodi.addItem("X");
        cmbprodi.addItem("XI");
        cmbprodi.addItem("XII");
        
    }
    else if(cmbfakultas.getSelectedItem().equals("TKJ")){
        cmbprodi.setEnabled(true);
        cmbprodi.removeAllItems();
        cmbprodi.addItem("X");
        cmbprodi.addItem("XI");
    ...
    else if(cmbfakultas.getSelectedItem().equals("ELIN")){
        cmbprodi.setEnabled(true);
        cmbprodi.removeAllItems();
         cmbprodi.addItem("X");
        cmbprodi.addItem("XI");
    ...
    else if(cmbfakultas.getSelectedItem().equals("TL")){
        cmbprodi.setEnabled(true);
        cmbprodi.removeAllItems();
         cmbprodi.addItem("X");
        cmbprodi.addItem("XI");
        cmbprodi.addItem("XII");
    }  else if(cmbfakultas.getSelectedItem().equals("las")){
        cmbprodi.setEnabled(true);
        cmbprodi.removeAllItems();
         cmbprodi.addItem("X");
        cmbprodi.addItem("XI");
        cmbprodi.addItem("XII");}  else if(cmbfakultas.getSelectedItem().equals("tkr")){
        cmbprodi.setEnabled(true);
        cmbprodi.removeAllItems();
         cmbprodi.addItem("X");
        cmbprodi.addItem("XI");
    ...
    else if(cmbfakultas.getSelectedItem().equals("jurusan")||cmbprodi.getSelectedItem().equals("kelas")){
